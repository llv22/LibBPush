#
#  Be sure to run `pod spec lint LibBPush.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of LibBPush in Markdown format.
  ...
  s.author             = { "Orlando Ding" => "xiandao.airs@gmail.com" }
  # Or just: s.author    = "Orlando Ding"
  # s.authors            = { "Orlando Ding" => "xiandao.airs@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Orlando Ding"
  ...
  # s.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '$(PODS_ROOT)/../../LibBPush' }
